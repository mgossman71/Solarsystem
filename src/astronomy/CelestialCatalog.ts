...
export const CATALOG: readonly CelestialBody[] = [
  ...
  },
  {
    ...
    textures: { body: '/assets/venus/venus.jpg' },
    notes: 'Thick CO2 atmosphere, pale yellow-white clouds; retrograde rotation; no moons.',
  },
  {
  ...
  },
  {
    ...
    radiusKm: 69911, equatorialRadiusKm: 69911, polarRadiusKm: 66854,
  ...
  },
  {
    ...
    radiusKm: 60268, equatorialRadiusKm: 60268, polarRadiusKm: 58350,
  ...
  },
  {
    ...
    textures: { body: '/assets/uranus/uranus.jpg', ring: '/assets/uranus/ring.png' },
    notes: 'Extreme axial tilt (~98°) — rolls on its side; thin ring system; five major moons.',
  },
  {
    ...
    textures: { body: '/assets/neptune/neptune.jpg', ring: '/assets/neptune/ring.png' },
    notes: 'Deep-blue methane ice giant; faint ring arcs; large retrograde moon Triton.',
  },
  {
  ...
  { id: 'charon', name: 'Charon', kind: 'terrestrial', parent: 'pluto', radiusKm: 606,
    ...
    moon: { semiMajorAxisKm: 19596, inclinationDeg: 0.0, nodeDeg: 0, periodDays: 6.387, meanLongitudeDeg: 0, tidallyLocked: true, retrograde: false, radiusKm: 606 },
  ...
  { id: 'styx', name: 'Styx', kind: 'terrestrial', parent: 'pluto', radiusKm: 5.5,
    ...
    elements: null, epochDays: 0, textures: { body: '/assets/pluto/moons/styx.jpg' },
  ...
  { id: 'nix', name: 'Nix', kind: 'terrestrial', parent: 'pluto', radiusKm: 10,
    ...
    elements: null, epochDays: 0, textures: { body: '/assets/pluto/moons/nix.jpg' },
  ...
  { id: 'kerberos', name: 'Kerberos', kind: 'terrestrial', parent: 'pluto', radiusKm: 8.5,
    ...
    elements: null, epochDays: 0, textures: { body: '/assets/pluto/moons/kerberos.jpg' },
  ...
  { id: 'hydra', name: 'Hydra', kind: 'terrestrial', parent: 'pluto', radiusKm: 8.5,
    ...
    elements: null, epochDays: 0, textures: { body: '/assets/pluto/moons/hydra.jpg' },
